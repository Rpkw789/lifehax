// @ts-nocheck — vendored third-party source, not typechecked here.
// Tremor is written against a looser tsconfig than ours. Under `strict` it
// reports four errors, all the same cause: recharts types a tooltip `label` as
// `string | number | undefined` and this file assumes `string`. Editing the
// four sites would make re-copying upstream harder to reason about, so the
// file is excluded from typechecking instead. See ./README.md.
